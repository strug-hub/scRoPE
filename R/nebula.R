...
#' @param covariance If TRUE, scRoPE will output the covariance matrix for the estimated log(FC), which can be used for testing contrasts.
#' @param output_re If TRUE, scRoPE will output the subject-level random effects. Only effective for model='NBGMM' or 'NBLMM'.
